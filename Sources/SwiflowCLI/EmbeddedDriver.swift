...
(function(){"use strict";const o=new Map,m=new Map;let y=null;const x=new Map,_="./.build/plugins/PackageToJS/outputs/Package/App.wasm";function b(e){const t=document.createElement("template");if(t.innerHTML=e,t.content.childNodes.length===1)return t.content.firstChild;const n=document.createElement("span");for(;t.content.firstChild;)n.appendChild(t.content.firstChild);return n}function k(e){const t=e.target,n=t instanceof Element?t:t&&t.parentElement||null;if(!n||!n.closest||!e.currentTarget)return!1;const r=n.closest("a[href],button,input,select,textarea,summary,label,[contenteditable]:not([contenteditable='false'])");return!!(r&&r!==e.currentTarget&&e.currentTarget.contains&&e.currentTarget.contains(r))}function C(e){const t=e.target,n=t&&"value"in t?String(t.value):null,r=t&&"checked"in t?!!t.checked:null,l=typeof e.key=="string"?e.key:null;return{type:e.type,targetValue:n,targetChecked:r,isSelfTarget:t===e.currentTarget,fromInteractiveDescendant:k(e),key:l,shiftKey:!!e.shiftKey,ctrlKey:!!e.ctrlKey,altKey:!!e.altKey,metaKey:!!e.metaKey,detail:e.detail!==null&&typeof e.detail=="object"?JSON.stringify(e.detail):null}}function E(e){switch(e.op){case"createElement":o.set(e.handle,document.createElement(e.tag));return;case"createText":o.set(e.handle,document.createTextNode(e.text));return;case"createRawHTML":{o.set(e.handle,b(e.html));return}case"destroyNode":{const t=o.get(e.handle);for(const n of Array.from(m.keys())){const r=n.indexOf(":");if(r<0||Number(n.slice(0,r))!==e.handle)continue;const l=n.slice(r+1),d=m.get(n);t!==void 0&&d!==void 0&&t.removeEventListener(l,d),m.delete(n)}o.delete(e.handle);return}case"animateExit":{const t=o.get(e.handle),n=o.get(e.parentHandle);if(!t)return;t.style.animation=e.animation,setTimeout(function(){n&&t.parentNode===n?n.removeChild(t):t.parentNode&&t.parentNode.removeChild(t),o.delete(e.handle)},e.durationMs);return}case"appendChild":o.get(e.parent).appendChild(o.get(e.child));return;case"insertBefore":o.get(e.parent).insertBefore(o.get(e.child),o.get(e.beforeChild));return;case"removeChild":o.get(e.parent).removeChild(o.get(e.child));return;case"setAttribute":o.get(e.handle).setAttribute(e.name,e.value);return;case"removeAttribute":o.get(e.handle).removeAttribute(e.name);return;case"setProperty":if(e.name==="innerHTML")throw new Error("swiflow: setProperty refuses to write the innerHTML property; use VNode.rawHTML(_:) instead");o.get(e.handle)[e.name]=e.value;return;case"removeProperty":delete o.get(e.handle)[e.name];return;case"setStyle":e.name.startsWith("--")?o.get(e.handle).style.setProperty(e.name,e.value):o.get(e.handle).style[e.name]=e.value;return;case"removeStyle":o.get(e.handle).style.removeProperty(e.name);return;case"setText":{const t=o.get(e.handle);t.data!==void 0?t.data=e.text:t.textContent=e.text;return}case"setRawHTML":{const t=b(e.html),n=o.get(e.handle);n&&n.parentNode&&n.parentNode.replaceChild(t,n),o.set(e.handle,t);return}case"addHandler":{const t=e.handlerId,n=e.handle+":"+e.event,r=m.get(n);r!==void 0&&o.get(e.handle).removeEventListener(e.event,r);const l=function(d){window.__swiflowDispatch(t,C(d))};o.get(e.handle).addEventListener(e.event,l),m.set(n,l);return}case"removeHandler":{const t=e.handle+":"+e.event,n=m.get(t);n!==void 0&&(o.get(e.handle).removeEventListener(e.event,n),m.delete(t));return}case"replaceMount":{const t=document.querySelector(e.selector);if(t===null)throw new Error("swiflow-driver: replaceMount target '"+e.selector+"' not found");const n=x.get(e.selector);n!==void 0&&n.parentNode===t&&t.removeChild(n);const r=o.get(e.newHandle);x.set(e.selector,r),t.appendChild(r);return}default:console.error("swiflow-driver: unknown opcode",e.op,e);return}}async function v(e){const t=await fetch(e);if(!t.ok)throw new Error("swiflow: fetch "+e+" failed ("+t.status+")");const n=parseInt(t.headers.get("Content-Length")||"",10),r=t.body&&t.body.getReader?t.body.getReader():null;if(!r)return document.documentElement.dataset.swiflowProgress="100",t;const l=[];let d=0;const h=Number.isFinite(n)&&n>0;try{for(;;){const{done:i,value:a}=await r.read();if(i)break;if(l.push(a),d+=a.byteLength,h){const s=Math.floor(d/n*100);document.documentElement.dataset.swiflowProgress=String(Math.min(s,99))}}}catch(i){try{await r.cancel()}catch{}throw i}document.documentElement.dataset.swiflowProgress="100";const g=new Blob(l,{type:t.headers.get("Content-Type")||"application/wasm"});return new Response(g,{headers:t.headers,status:t.status})}if(window.swiflow={applyPatches:function(e){let t=!0;for(let n=0;n<e.length;n++)try{E(e[n])}catch(r){t=!1,console.error("swiflow-driver: patch failed (op "+(e[n]&&e[n].op)+", index "+n+" of "+e.length+")",e[n],r)}return t},mount:function(e,t){const n=document.querySelector(t);if(n===null)throw new Error("swiflow-driver: mount target '"+t+"' not found");y=t,x.set(t,o.get(e)),n.appendChild(o.get(e))},nodeForHandle:function(e){const t=o.get(e);return t===void 0?null:t},registerDispatcher:function(e){}},window.SWIFLOW_DEV){let e=function(){const i=document.getElementById("__swiflow-build-error-overlay");i&&i.remove()},t=function(i){e();const a=document.createElement("div");a.id="__swiflow-build-error-overlay",a.style.cssText="position:fixed;inset:0;z-index:999998;background:rgba(0,0,0,0.85);color:#fff;font-family:monospace;font-size:14px;padding:24px;overflow:auto;white-space:pre-wrap;word-break:break-word;";const s=document.createElement("div");s.style.cssText="font-size:18px;font-weight:bold;margin-bottom:16px;color:#ffa94d;",s.textContent="\u26A0 Swiflow rebuild failed \u2014 showing the last successful build";const c=document.createElement("pre");c.style.cssText="margin:0 0 16px;",c.textContent=i||"(no compiler output was forwarded \u2014 see the swiflow dev terminal)";const f=document.createElement("div");f.style.cssText="color:#aaa;font-size:12px;margin-bottom:16px;",f.textContent="Fix the error and save \u2014 this overlay clears on the next successful rebuild.";const w=document.createElement("button");w.style.cssText="padding:8px 16px;background:#444;color:#fff;border:none;cursor:pointer;font-size:14px;border-radius:4px;",w.textContent="Dismiss",w.onclick=function(){a.remove()},a.appendChild(s),a.appendChild(c),a.appendChild(f),a.appendChild(w),(document.body||document.documentElement).appendChild(a)},h=function(){const i=(location.protocol==="https:"?"wss://":"ws://")+location.host+"/reload",a=new WebSocket(i);a.onopen=function(){n=250},a.onmessage=function(s){let c;try{c=JSON.parse(s.data)}catch{return}if(c){if(c.type==="reload"){location.reload();return}if(c.type==="hmr-swap"){e(),g(c);return}if(c.type==="build-error"){t(typeof c.message=="string"?c.message:"");return}}},a.onclose=function(){setTimeout(h,n),n=Math.min(n*2,r)},a.onerror=function(){}};if(console.log(`[swiflow dev] For Swift source locations in stack traces,
install the Chrome C/C++ DevTools Extension:
  https://goo.gle/wasm-debugging-extension
Then reload DevTools \u2014 DWARF support activates automatically.`),window.__swiflowDevError=function(i){console.error(`[swiflow] render error \u2014 WASM execution stopped.
Reload the page to recover.

`+(i&&i.stack?i.stack:String(i)));const a=document.getElementById("__swiflow-error-overlay");a&&a.remove();const s=document.createElement("div");s.id="__swiflow-error-overlay",s.style.cssText="position:fixed;inset:0;z-index:999999;background:rgba(0,0,0,0.85);color:#fff;font-family:monospace;font-size:14px;padding:24px;overflow:auto;white-space:pre-wrap;word-break:break-word;";const c=document.createElement("div");c.style.cssText="font-size:18px;font-weight:bold;margin-bottom:16px;color:#ff6b6b;",c.textContent="\u26A0 Swiflow render error \u2014 WASM execution stopped";const f=document.createElement("pre");f.style.cssText="margin:0 0 16px;",f.textContent=i&&i.stack?i.stack:String(i);const w=document.createElement("div");w.style.cssText="color:#aaa;font-size:12px;margin-bottom:4px;",w.textContent="Install the Chrome C/C++ DevTools Extension to see Swift file:line in the stack above:";const u=document.createElement("a");u.href="https://goo.gle/wasm-debugging-extension",u.target="_blank",u.style.cssText="color:#4dabf7;font-size:12px;display:block;margin-bottom:16px;",u.textContent="https://goo.gle/wasm-debugging-extension";const p=document.createElement("button");p.style.cssText="padding:8px 16px;background:#444;color:#fff;border:none;cursor:pointer;font-size:14px;border-radius:4px;",p.textContent="Dismiss (app is frozen \u2014 reload to continue)",p.onclick=function(){s.remove()},s.appendChild(c),s.appendChild(f),s.appendChild(w),s.appendChild(u),s.appendChild(p),(document.body||document.documentElement).appendChild(s)},typeof window.requestAnimationFrame=="function"){var T=window.requestAnimationFrame.bind(window);window.requestAnimationFrame=function(i){return T(function(a){try{i(a)}catch(s){window.__swiflowDevError(s)}})}}let n=250;const r=5e3;let l=!1,d=null;async function g(i){if(l){d=i;return}l=!0;const a=performance.now();try{const s=window.__swiflow&&window.__swiflow.hmrSnapshot?window.__swiflow.hmrSnapshot():null;if(window.__swiflowPendingSnapshot=s,o.clear(),m.clear(),y){const u=document.querySelector(y);u&&u.replaceChildren()}document.querySelectorAll('style[id^="swiflow-"]').forEach(function(u){u.remove()});const c=window.swiflow&&window.swiflow.__importOverride||(u=>import(u)),{init:f}=await c(i.jsURL);await f({module:v(i.wasmURL)});const w=(performance.now()-a).toFixed(1);console.log("[swiflow] hmr-swap took "+w+"ms")}catch(s){console.warn("[swiflow] HMR swap failed, falling back to full reload:",s),location.reload();return}finally{l=!1}if(d!==null){const s=d;d=null,g(s)}}h()}window.swiflow.__boot=async function({swiflowDev:t}){if("serviceWorker"in navigator){if(t){const n=await navigator.serviceWorker.getRegistrations();for(const r of n)if(((r.active||r.installing||r.waiting)?.scriptURL??"").endsWith("/swiflow-service-worker.js"))try{await r.unregister()}catch{}if(typeof caches<"u")try{const r=await caches.keys();await Promise.all(r.filter(l=>l.startsWith("swiflow-")).map(l=>caches.delete(l)))}catch{}return}try{await navigator.serviceWorker.register("swiflow-service-worker.js")}catch(n){console.warn("swiflow: service worker registration failed",n)}}},window.swiflow.__bootForTest=window.swiflow.__boot,window.swiflow.__test_fetchWithProgress=v,(async()=>{if(!window.__SWIFLOW_SKIP_BOOT&&(await window.swiflow.__boot({swiflowDev:!!window.SWIFLOW_DEV}),!window.swiflow.__inited)){window.swiflow.__inited=!0;try{const{init:e}=await import("./.build/plugins/PackageToJS/outputs/Package/index.js");await e({module:v(_)})}catch(e){console.error("swiflow: WASM init failed",e)}}})()})();
