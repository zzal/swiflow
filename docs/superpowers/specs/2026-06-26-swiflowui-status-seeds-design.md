...
error red or success green (e.g. a rose `#e11d48` danger, an emerald `#059669` success) has no
...
```
swiflow theme --primary "#7c3aed" --danger "#e11d48" --success "#059669" [--neutrals] [--out path]
```
...
pass**, and the example seeds `#e11d48`/`#059669` pass. A uniform 4.5 raw bar was rejected because
...
```css
/* Generated by `swiflow theme --primary #7c3aed --danger #e11d48 --success #059669`.
...
:root {
  ...
  --sw-success: light-dark(#059669, <derived>);
}
```
...
- **`SwiflowColorTests`:**
  ...
  - `accentThemeCSS(primaryHex: "#7c3aed", dangerHex: "#e11d48", successHex: "#059669")` contains
...
- **`SwiflowCLITests`:** `theme --primary "#7c3aed" --danger "#e11d48" --success "#059669" --out
